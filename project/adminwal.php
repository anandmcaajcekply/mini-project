...
if($ds!='')
{
	echo "<script>if(confirm('account already exists!!!!')){document.location.href='adminhome.php'}else{document.location.href='adminhome.php'};</script>";
...
<img src="images1/b1.jpg" alt="Icon" style="width:130%;height:90%;">
			...
			<span style="color:pink;"><b>Amount</b></span><span style="color:red;">*</span>:<input type="text" name="amount" id="loc" required style="z-index:50px; width:120%; height:50px; background-color: white; color:#F59024;" >
			<span style="color:pink;"><b>cvv</b></span><span style="color:red;">*</span>:<input type="text" name="cvv" id="loc" required style="z-index:50px; width:120%; height:50px;  color:red; background-color: white; color:#F59024;" >
		<span style="color:pink;"><b>Card no</b></span><span style="color:red;">*</span>:<input type="text" name="cardno" id="loc" required style="z-index:50px; width:120%; height:50px;  color:red; background-color: white; color:#F59024;" >
